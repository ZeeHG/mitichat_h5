<template>
  <div class="flex-1 overflow-hidden relative">
    <div v-if="showGroupAnnouncement" class="group_announcement_tab" @click="toGroupAnnouncement">
...
import { GroupAtType, MessageType } from '@/utils/open-im-sdk-wasm/types/enum';
...
const showGroupAnnouncement = computed(() => conversationStore.storeCurrentConversation.groupAtType === GroupAtType.AtGroupNotice)

const resetGroupAnnouncement = () => {
  IMSDK.resetConversationGroupAtType(conversationStore.storeCurrentConversation.conversationID);
}
