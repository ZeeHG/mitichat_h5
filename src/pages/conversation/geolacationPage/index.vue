<template>
  <div class="h-full relative">
    <div class="absolute left-3 right-3 top-3 z-10 text-2xl flex justify-between">
      <van-icon name="arrow-left" @click="$router.back" />
      <van-button type="primary" size="mini" @click="sendLocation">{{ $t('buttons.send') }}</van-button>
    </div>
