<template>
  <div class="page_container !bg-white">
    <NavBar :title="title">
      <span :disabled="!value && !friendInfo" @click="saveChange">{{ t("buttons.save") }}</span>
    </NavBar>

    <div class="mx-6 mt-10">
      <div class="border border-gap-text rounded-lg ">
        <van-field class="!py-1" v-model="value" :maxlength="16" label=""
...
const value = ref(props.friendInfo ? props.friendInfo?.remark : userStore.storeSelfInfo.nickname)
